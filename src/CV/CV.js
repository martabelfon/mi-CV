export const CV = {
    hero: [
      ...
      education: [
        ...
        {
            name: "PROGRAMA SUPERIOR UNIVERSITARIO EN DIRECCIÓN DE RECURSOS HUMANOS",
            date: "2019-2021",
            where: "EAE Business School",
          },
          {
            name: "CERTIFICACIÓN BÁSICA DE PREVENCIÓN DE RIESGOS LABORALES (PRL)",
            date: "2021",
            where: "ICF Consultoria & Formación",
          },
          {
            name: "CFGS ADMINISTRACIÓN Y FINANZAS",
            date: "2016-2019",
            where: "Linkia",
          },
      ],
      experience: [
        {
          name: "Técnica de Selección y Desarrollo",
